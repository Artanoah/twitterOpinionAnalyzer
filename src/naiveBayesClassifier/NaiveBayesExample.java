...
import naiveBayesClassifier.NaiveBayesKnowledgeBase;
...
public class NaiveBayesExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        trainingFiles.put("bad", NaiveBayesExample.class.getResource("/datasets/training.language.en.txt"));
        trainingFiles.put("good", NaiveBayesExample.class.getResource("/datasets/training.language.fr.txt"));
